...
var mobileMenuTitle = "Menu",					//The title of the mobile menu
  ...
  map_initial_latitude = 33.779613,			//Google map initial Latitude. If "null", latitude of the first marked will be used
  map_initial_longitude = -118.066904,		//Google map initial Longitude. If "null", longitude of the first marked will be used
